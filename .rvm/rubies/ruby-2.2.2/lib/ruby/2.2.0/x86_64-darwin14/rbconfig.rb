...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/haven/.rvm/rubies/ruby-2.2.2")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/haven/.rvm/rubies/ruby-2.2.2' '--enable-load-relative' '--with-static-linked-ext' '--without-ext=dl/win32,fiddle/win32,tk/tkutil,tk,win32ole,-test-/win32/dln,-test-/win32/fd_setsize' '--sysconfdir=/etc' '--disable-install-doc' '--disable-shared' '--with-arch=x86_64' 'CC=gcc' 'CFLAGS=-O3 -I/Users/haven/.sm/pkg/active/include -fPIC -mmacosx-version-min=10.7' 'LDFLAGS=-L/Users/haven/.sm/pkg/active/lib -fPIC -Bstatic -lz'"
  ...
  CONFIG["LDFLAGS"] = "-L. -L/Users/haven/.sm/pkg/active/lib -fPIC -Bstatic -lz -fstack-protector -L/usr/local/lib"
  CONFIG["CFLAGS"] = "-O3 -I/Users/haven/.sm/pkg/active/include -fPIC -mmacosx-version-min=10.7 -pipe"
  CONFIG["CXX"] = "g++"
  CONFIG["CC"] = "gcc"
  ...
  CONFIG["host_os"] = "darwin14.4.0"
  CONFIG["host_vendor"] = "apple"
  CONFIG["host_cpu"] = "x86_64"
  CONFIG["host"] = "x86_64-apple-darwin14.4.0"
  CONFIG["RUBY_VERSION_NAME"] = "$(RUBY_BASE_NAME)-$(ruby_version)"
  CONFIG["RUBYW_BASE_NAME"] = "rubyw"
  CONFIG["RUBY_BASE_NAME"] = "ruby"
  CONFIG["build_os"] = "darwin14.4.0"
  CONFIG["build_vendor"] = "apple"
  CONFIG["build_cpu"] = "x86_64"
  CONFIG["build"] = "x86_64-apple-darwin14.4.0"

...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/travis/.rvm/rubies/ruby-2.1.1")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/travis/.rvm/rubies/ruby-2.1.1' '--enable-load-relative' '--with-static-linked-ext' '--without-ext=dl/win32,fiddle/win32,tk/tkutil,tk,win32ole,-test-/win32/dln,-test-/win32/fd_setsize' '--sysconfdir=/etc' '--disable-install-doc' '--disable-shared' '--with-arch=x86_64' 'CC=/usr/bin/clang' 'CFLAGS=-O3 -I/Users/travis/.sm/pkg/active/include -fPIC -mmacosx-version-min=10.6' 'LDFLAGS=-L/Users/travis/.sm/pkg/active/lib -fPIC -Bstatic'"
  ...
  CONFIG["CFLAGS"] = "-O3 -I/Users/travis/.sm/pkg/active/include -fPIC -mmacosx-version-min=10.6 -pipe"
  CONFIG["CC"] = ENV["CC"] || "/usr/bin/clang"
